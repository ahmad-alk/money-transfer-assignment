...
public class AccountDaoUnitTest {
    ...
    public void should_transfer_successfully() throws SQLException {
        ...
        AccountRecord accountFrom = new AccountRecord(1000L, BigDecimal.valueOf(3000L), Short.valueOf("1"), "test", new Timestamp(100L), 10, 1);
        AccountRecord accountTo = new AccountRecord(2000L, BigDecimal.valueOf(1000L), Short.valueOf("1"), "test", new Timestamp(100L), 20, 2);
        ...
        BDDMockito.given(using(mockConfiguration)
                .update(ACCOUNT).set(ACCOUNT.ACC_BALANCE, accountTo.getAccBalance().subtract(amount))
        ...
        BDDMockito.given(using(mockConfiguration)
                .update(ACCOUNT).set(ACCOUNT.ACC_BALANCE, accountFrom.getAccBalance().add(amount))
