CREATE TABLE REVOLUT_DB_4.USER
(
...
CREATE TABLE REVOLUT_DB_4.ACCOUNT
(
    ...
    PRIMARY KEY (ACC_NO),
    CONSTRAINT ACC_USER_ID_FK FOREIGN KEY (USER_ID) REFERENCES REVOLUT_DB_4.USER (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
);



CREATE TABLE REVOLUT_DB_4.ACCOUNT_TRANSACTIONS
(
    AT_ID      INT         NOT NULL,
    AT_FROM    long        NOT NULL,
    AT_TO      long        NOT NULL,
    AT_AMOUNT  DECIMAL(10) NULL,
    ...
    CONSTRAINT AT_ACC_FROM
        FOREIGN KEY (AT_FROM)
            REFERENCES REVOLUT_DB_4.ACCOUNT (ACC_NO)
            ON DELETE NO ACTION
            ON UPDATE NO ACTION,
