 ...
 * the <code>REVOLUT_SCHEMA</code> schema.
 */
@Generated(
        value = {
                "http://www.jooq.org",
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<AccountRecord, UserRecord> ACC_USER_ID_FK = Internal.createForeignKey(com.revolut.demo.jooq.model.revolut_schema.Keys.CONSTRAINT_2, Account.ACCOUNT, "ACC_USER_ID_FK", Account.ACCOUNT.USER_ID);
        public static final ForeignKey<AccountTransactionsRecord, AccountRecord> AT_ACC_FROM = Internal.createForeignKey(com.revolut.demo.jooq.model.revolut_schema.Keys.CONSTRAINT_E, AccountTransactions.ACCOUNT_TRANSACTIONS, "AT_ACC_FROM", AccountTransactions.ACCOUNT_TRANSACTIONS.AT_FROM);
        public static final ForeignKey<AccountTransactionsRecord, AccountRecord> AT_ACC_TO = Internal.createForeignKey(com.revolut.demo.jooq.model.revolut_schema.Keys.CONSTRAINT_E, AccountTransactions.ACCOUNT_TRANSACTIONS, "AT_ACC_TO", AccountTransactions.ACCOUNT_TRANSACTIONS.AT_TO);
    }
}
