...
public class AccountTransactionsRecord extends UpdatableRecordImpl<AccountTransactionsRecord> implements Record7<Integer, Long, Long, BigDecimal, String, Timestamp, String> {
    ...
    @Override
    public Row7<Integer, Long, Long, BigDecimal, String, Timestamp, String> valuesRow() {
    ...
    @Override
    public AccountTransactionsRecord values(Integer value1, Long value2, Long value3, BigDecimal value4, String value5, Timestamp value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
