...
public class Account extends TableImpl<AccountRecord> {
    ...
    private static final long serialVersionUID = -996131111;

    /**
     * The reference instance of <code>REVOLUT_SCHEMA.ACCOUNT</code>
     */
    ...
    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.ACC_NO</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.ACC_BALANCE</code>.
     */
    public final TableField<AccountRecord, BigDecimal> ACC_BALANCE = createField(DSL.name("ACC_BALANCE"), org.jooq.impl.SQLDataType.DECIMAL(20, 3).nullable(false), this, "");

    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.ACC_ACTIVE</code>.
     */
    public final TableField<AccountRecord, Short> ACC_ACTIVE = createField(DSL.name("ACC_ACTIVE"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("1", org.jooq.impl.SQLDataType.SMALLINT)), this, "");

    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.ACC_TYPE</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.ACC_CREATED_DATE</code>.
     */
    public final TableField<AccountRecord, Timestamp> ACC_CREATED_DATE = createField(DSL.name("ACC_CREATED_DATE"), org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.ACC_VERSION</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_SCHEMA.ACCOUNT.USER_ID</code>.
     */
    ...
    /**
     * Create a <code>REVOLUT_SCHEMA.ACCOUNT</code> table reference
     */
    public Account() {
    ...
    /**
     * Create an aliased <code>REVOLUT_SCHEMA.ACCOUNT</code> table reference
     */
