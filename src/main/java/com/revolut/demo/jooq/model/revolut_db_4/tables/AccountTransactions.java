...
public class AccountTransactions extends TableImpl<AccountTransactionsRecord> {
    ...
    private static final long serialVersionUID = 2026924042;

    /**
     * The reference instance of <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS</code>
     */
    ...
    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_ID</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_FROM</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_TO</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_AMOUNT</code>.
     */
    public final TableField<AccountTransactionsRecord, Long> AT_AMOUNT = createField(DSL.name("AT_AMOUNT"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_STATUS</code>.
     */
    ...
    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_DATE</code>.
     */
    public final TableField<AccountTransactionsRecord, Timestamp> AT_DATE = createField(DSL.name("AT_DATE"), org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).defaultValue(DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS.AT_REMARKS</code>.
     */
    ...
    /**
     * Create a <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS</code> table reference
     */
    ...
    /**
     * Create an aliased <code>REVOLUT_DB_4.ACCOUNT_TRANSACTIONS</code> table reference
     */
